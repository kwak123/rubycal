...
module RubyCal
  ...
  class Event
    ...
    def initialize(params)
      ...
      raise ArgumentError, "Event cannot after end" unless params[:all_day] || (params[:start_time] <= params[:end_time])
      @name = params[:name]
    ...
    def update_event(params)
      ...
      raise ArgumentError, "Event cannot after end" unless test_vars['all_day'] || (test_vars['start_time'] <= test_vars['end_time'])
      params.each do |k, v|
